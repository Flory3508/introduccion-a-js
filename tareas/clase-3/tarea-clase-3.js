 ...
 let nombreUsuario = prompt('Por favor, ingresa tu nombre', 'Tu nombre aqui').toLowerCase();
 ...
 let consultaDni = prompt('¿Tenés dni? Si o No').toLowerCase().trim();
 if (consultaDni === 'si') {
     if (edadUsuario >= 18) {
